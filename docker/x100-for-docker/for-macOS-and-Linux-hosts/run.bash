...
if   [ "$cpuArch" == "arm64" ]; then
     # Apple M1
     image="tempestobserver/x100-image-arm64v8"
     ...
     #Linux arm32v7
     image="tempestobserver/x100-image-arm32v7"
     container="x100-container-arm32v7"
elif [ "$cpuArch" == "x86_64" ]; then
     image="tempestobserver/x100-image-amd64"
...
docker create  ${tmpfs}  ${volume}  --privileged  --interactive  --network=host  --name ${container}  ${image}
